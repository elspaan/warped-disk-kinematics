...
file_data = 'image_lines_incl10_02-twisted-wa5-twist0_mod_noisy_convolved'
dpc =150.*u.pc
#**********************
...
datacube.clip(npix=400, overwrite=True, channels={'interval': [60, 150]}) # can also clip along the velocity axis using e.g. channels={"interval": [15, 115]})
