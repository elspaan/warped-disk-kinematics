...
#SOME DEFINITIONS
#*********************
foldername = 'Linas_cubes/fits-and-analysis/incl30_02-twisted-wa5'
diskname = 'image_lines_incl30_02-twisted-wa5_mod_noisy_convolved'
file_data = f'../image_lines_incl30_02-twisted-wa5_mod_noisy_convolved_clipped_downsamp_8pix.fits'
tag_out = 'synthcube_12co_incl30-02-twisted-wa5_mod' #PREFERRED FORMAT: disc_mol_chan_program_extratags
tag_in = tag_out
...
z0_upper, p_upper, Rb_upper, q_upper = 46.9, 1.3, 280.9, 6.358 # norm. cte, R-power1 (flare), taper point radius, R-power2 (exp. taper); au
z0_lower, p_lower, Rb_lower, q_lower = 40, 1.3, 280.9, 6.358 # same definition as upper surface
