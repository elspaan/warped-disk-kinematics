...
file_data = 'image_lines_incl30_02-twisted-wa5_mod_noisy_convolved'
dpc =150.*u.pc
#**********************
...
datacube.clip(npix=400, overwrite=True) # can also clip along the velocity axis using e.g. channels={"interval": [15, 115]})
