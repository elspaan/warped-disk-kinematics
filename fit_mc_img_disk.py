...
z0_lower, p_lower, Rb_lower, q_lower = 25, 1.0, 300, 3.0 # same definition as upper surface
...
# include line width here, and om==p, q of intensity (as above) and modify this in the protofile.
...
if __name__ == '__main__': # this fixes a weird bug. Indent is important.
    ...
    model.run_mcmc(datacube.data, vchannels,
                   ...
                   backend=backend,
                   tag=tag_out,
                   nthreads=62, # If not specified considers maximum possible number of cores
