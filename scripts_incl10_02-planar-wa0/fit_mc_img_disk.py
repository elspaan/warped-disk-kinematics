...
#SOME DEFINITIONS
#*********************
foldername = 'Linas_cubes/fits-and-analysis/incl10_02-planar-wa0/'
diskname = 'disk_name'
file_data = f'../image_lines_incl10_02-planar-wa0_mod_noisy_convolved_clipped_downsamp_8pix.fits'
tag_out = 'synthcube_12co_incl10_02-planar-wa0_mod' #PREFERRED FORMAT: disc_mol_chan_program_extratags
tag_in = tag_out
